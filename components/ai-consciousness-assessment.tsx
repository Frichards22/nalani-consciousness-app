...
export default function AIConsciousnessAssessment({
  ...
  const getELICoaching = async (question: any, response: string): Promise<any> => {
    ...
    if (responseText.includes("bad people") || responseText.includes("toxic")) {
      return {
        analysis: `💔 **"${response}"** - That pattern of gravitating toward toxic people is your wounded inner child seeking familiar chaos. You're not broken - you're just repeating what feels 'normal' even when it hurts.`,
    ...
    // Generic fallback
    return {
      analysis: `✨ **"${response}"** - Your honest response reveals exactly where your consciousness is ready to expand.`,
